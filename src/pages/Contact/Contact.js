    ...
    <>
      ...
      <div className="exerpt exerpt-geometric">
        <div className="container">
          ...
          <p>
            <b>
              How a digital interview builder supports all organizational roles
            </b>
          </p>
          <p>
            Your hiring managers are probably experts in their technical fields
            — they are not always savvy when it comes to proper hiring
            practices, or even the legal elements behind finding the right
            candidate. Instead of struggling to educate every individual manager
            about the subtleties of hiring, why not trust a performance
            management appraisal systems expert instead? Quintela offers
            interviewing guides that are designed to make consistent, measurable
