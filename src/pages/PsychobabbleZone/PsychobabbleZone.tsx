...
import type { ArticleMeta, FeaturedArticleMeta } from "../../types/article";

const isFeaturedArticleMeta = (
  article: ArticleMeta,
  ...
  return (
    <>
      <PageHeader
        ...
        bkgClassName="bkgCmp text-center"
      />

      <div className="container ptThree">
        <div className="row row-cols-1 row-cols-md-2 row-cols-xl-2 g-4 justify-content-center">
          {FEATURED_ARTICLES.filter(isFeaturedArticleMeta).map((article) => (
